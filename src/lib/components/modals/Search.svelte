          ...
          <li class="text-lg">
            ...
            >
              <div class="grid grid-cols-1 w-full h-full">
                <div
                  class="flex w-full h-full col-span-1 rounded-none justify-between"
                >
                  <div class="flex flex-inline items-center">
                    <!-- <i class="fa-regular fa-file" /> -->
                    <span class=" w-full h-full pt-1 pr-1">
                      <iconify-icon icon="ic:round-newspaper" /></span
                    >
                    <span
                      class="flex flex-inline font-bold opacity-75 max-w-full"
                      >{shortenText(post.title, 25)}</span
                    >
                  </div>
                  <div class="flex flex-inline items-center text-xs opacity-50">
                    /blog/{post.slug}
                  </div>
                </div>
  ...
  >
    <div class="w-full grid grid-cols-1 md:grid-cols-3">
      ...
      >
        ...
        >
        <div
          class="md:hidden flex items-center align-middle justify-center px-4"
        >
          <LightSwitch />
        </div>
      </div>
